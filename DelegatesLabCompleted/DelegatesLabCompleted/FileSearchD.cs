...
namespace DelegatesLabCompleted
{
  class FileSearchD
  {
    ...
    public event BeforeFileFoundCancelHandler BeforeFileFound;
    ...
    protected virtual Boolean OnBeforeFileFound(
      FileInfo file)
    {
        FileFoundCancelEventArgs e = 
          new FileFoundCancelEventArgs(file);
      if (BeforeFileFound != null)
      {
        BeforeFileFound(file, e);
      }
      return e.Cancel;
    }
  }
